          ...
          {id === 1 && (
            ...
            <div className="object-center object-cover">
              ...
              <div className="font-sans font-semibold text-white text-sm md:text-xs lg:text-base z-10 mb-4 text-justify">
                <h1>As a <span className="text-purple font-semibold">Software Developer</span>, I have experience working with various technologies like <span className="text-purple font-semibold">Java, DBMS, DSA, Git, SQL, SDLC, Angular, NodeJS, HTML, CSS, Javascript and Typescript.</span>
                </h1>
              </div>
              <div className="font-sans font-semibold text-white text-sm md:text-xs lg:text-base z-10 mb-4 text-justify">
                <h1>Additionally, I served as the <span className="text-purple font-semibold">Beta MLSA</span> at Microsoft Learn, <span className="text-purple font-semibold">organizing workshops and events to teach Microsoft technologies</span>. I have a strong interest in Microsoft Cloud and software development.
                </h1>
              </div>
